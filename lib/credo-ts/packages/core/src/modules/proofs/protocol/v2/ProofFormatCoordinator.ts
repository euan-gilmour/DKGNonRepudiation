...
import {FormatCreateWrappedRequestOptions} from "../../formats";
...
export class ProofFormatCoordinator<PFs extends ProofFormatService[]> {
  ...
  public async processRequest(
    ...
    for (const formatService of formatServices) {
      let attachment:any = this.getAttachmentForService(formatService, message.formats, message.requestAttachments)
