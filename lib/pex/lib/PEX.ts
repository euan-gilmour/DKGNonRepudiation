import {
  AcpPolicy, AuthenticatedAcpPolicy,
  Format,
...
export class PEX {
  ...
  public presentationFrom(
    ...
    const presentation = PEX.constructPresentation(selectedCredentials, {
      ...
      acp: presentationDefinition.requestACP
    });
  ...
  public static constructPresentation(
    ...
    opts?: {
       ...
       */
      hasher?: Hasher;
      acp?: AcpPolicy | AuthenticatedAcpPolicy
    },
    ...
    if (credentials.some((c) => CredentialMapper.isSdJwtDecodedCredential(c) || CredentialMapper.isSdJwtEncoded(c))) {
      ...
      return {
        ...
        '@context': context,
        'requestACP': opts?.acp, // remove this if you want the acp policy on the same level of others
        type,
        holder,
